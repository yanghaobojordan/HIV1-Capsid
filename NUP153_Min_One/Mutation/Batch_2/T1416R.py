...
def main():
    ...
    mutate_residue(pose, pose.pdb_info().pdb2pose('O', 1416), "R")
    mutate_residue(pose, pose.pdb_info().pdb2pose('P', 1416), "R")
    mutate_residue(pose, pose.pdb_info().pdb2pose('M', 1416), "R")
    mutate_residue(pose, pose.pdb_info().pdb2pose('T', 1416), "R")
    mutate_residue(pose, pose.pdb_info().pdb2pose('U', 1416), "R")
    mutate_residue(pose, pose.pdb_info().pdb2pose('V', 1416), "R")
