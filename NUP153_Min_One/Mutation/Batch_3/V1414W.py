...
def main():
    ...
    mutate_residue(pose, pose.pdb_info().pdb2pose('O', 1414), "W")
    mutate_residue(pose, pose.pdb_info().pdb2pose('P', 1414), "W")
    mutate_residue(pose, pose.pdb_info().pdb2pose('M', 1414), "W")
    mutate_residue(pose, pose.pdb_info().pdb2pose('T', 1414), "W")
    mutate_residue(pose, pose.pdb_info().pdb2pose('U', 1414), "W")
    mutate_residue(pose, pose.pdb_info().pdb2pose('V', 1414), "W")
