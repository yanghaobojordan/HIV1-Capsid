...
def main():
    ...
    mutate_residue(pose, pose.pdb_info().pdb2pose('O', 1411), "Y")
    mutate_residue(pose, pose.pdb_info().pdb2pose('P', 1411), "Y")
    mutate_residue(pose, pose.pdb_info().pdb2pose('M', 1411), "Y")
    mutate_residue(pose, pose.pdb_info().pdb2pose('T', 1411), "Y")
    mutate_residue(pose, pose.pdb_info().pdb2pose('U', 1411), "Y")
    mutate_residue(pose, pose.pdb_info().pdb2pose('V', 1411), "Y")
